...
public final class ANTLRCharStream implements CharStream {
  ...
  public ANTLRCharStream(final LexerInput input, final String name) {
  ...
  @Override
  public int LA(final int lookaheadAmount) {
  ...
  private int lookBack(final int amount) {
  ...
  private int lookAhead(final int amount) {
  ...
  private void backup(final int count) {
